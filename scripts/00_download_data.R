...
modzcta_shape_topo_src <- "https://raw.githubusercontent.com/nychealth/coronavirus-data/refs/heads/master/Geography-resources/MODZCTA_2010_WGS1984.topo.json"
...
download_data(modzcta_shape_topo_src, raw_data_dir)
